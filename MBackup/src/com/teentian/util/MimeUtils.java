...
public final class MimeUtils {
    ...
    static {
        ...
        add("video/x-f4v", "f4v");
        add("video/x-flv", "flv");
        add("application/octet-stream", "dat");
        add("application/octet-stream", "dae");
        add("application/octet-stream", "pat");
        add("application/octet-stream", "idx");
        add("application/octet-stream", "exe");
        add("application/octet-stream", "db");
